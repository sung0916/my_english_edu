...
const ConfirmPasswordForWithdraw = () => {
    ...
    const handleConfirmPassword = async () => {
        ...
        try {
            ...
            await apiClient.post('/api/auth/confirm-password', { password } as any);

            // 비밀번호 확인 성공! withdraw 페이지로 이동합니다.
...
export default ConfirmPasswordForWithdraw;
